...
This was a project I mainly picked up to flex what I was learning with my first foray into hardware. I had been learning off the Arduino platform and wanted to try out a more substantial project. I took a fairly easy concept and applied everything I was learning to it. I didn't want to just breadboard a fritzing tutorial and download Arduino code; I wanted to do it my way.

I also made this project as a gift for my dad. Since Blynk allows commands to be sent via RESTful api, my dad ended up tinkering with his gift to let his Alexa control the cube!
# How it was Made
...
As you can see, 2 of the GPIO are Rx/Tx serial communication. The Rx line is guaranteed to be receiving signal from Wi-Fi communications, however the Tx line would only ever be outputting when I tell it to. So I used the Tx line as the Data Serial (DS) line to the shift registers.
